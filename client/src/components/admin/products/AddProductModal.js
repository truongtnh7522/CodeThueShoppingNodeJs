...
const AddProductDetail = ({ categories }) => {
  ...
  const [fData, setFdata] = useState({
    ...
    pDescription: "",
    pStatus: "Active",
    pImages: null, // Initial value will be null or empty array
    pCategory: "",
    pPrice: "",
    pOffer: 0,
    pQuantity: "",
        ...
        >
          ...
          <form className="w-full" onSubmit={(e) => submitForm(e)}>
            ...
            <div className="flex flex-col space-y-2">
              <label htmlFor="description">Thông tin nổi bật *</label>
              <textarea
            ...
            <div className="flex flex-col space-y-2">
              ...
              <textarea
                value={fData.pTechnicalspecifications}
                onChange={(e) =>
                  setFdata({
                    ...fData,
                    error: false,
                    success: false,
                    pTechnicalspecifications: e.target.value,
                  })
                }
                className="px-4 py-2 border focus:outline-none"
