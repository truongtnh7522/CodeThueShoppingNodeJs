...
const deleteProductReq = async (pId) => {
    try {
        ...
        } else if (deleteC && deleteC.success) {
...
const ProductTable = ({ product, deleteProduct, editProduct }) => {
      ...
      <tr>
        <td className="p-2 text-left">
          {product.pName.length > 15
            ? product.pDescription.substring(0, 15) + "..."
            : product.pName}
        </td>
        <td className="p-2 text-left">
  ...
  <td className="p-2 text-center">
    {new Intl.NumberFormat('vi-VN', { style: 'currency', currency: 'VND' }).format(product.pOffer !== 0 && product.pOffer !== "0" ? product.pOffer : product.pPrice)}
  </td>
  <td className="p-2 text-center">
    {new Intl.NumberFormat('vi-VN', { style: 'currency', currency: 'VND' }).format(product.pOffer !== 0 && product.pOffer !== "0" ? product.pPrice : product.pOffer)}
  </td>
       <td className="p-2 text-center">
