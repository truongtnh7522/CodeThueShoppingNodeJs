                        ...
                        <div className="relative w-full flex flex-col">
                          ...
                          <div className="flex items-center justify-between">
                            ...
                            <div>
                              ...
                              {`${subTotal(item._id, item.pPrice).toLocaleString('vi-VN')} đ`}
                            </div>{" "}
                            {/* SUbtotal Count */}
                          </div>
            ...
            {data.cartTotalCost ? (
              <Fragment>
                {isAuthenticate() ? (
                  ...
                  >
                    Checkout: {`${data.cartTotalCost.toLocaleString('vi-VN')} đ`}
                  </div>
                ) : (
                  <div
                    className="px-4 py-2 bg-black text-white text-center cursor-pointer"
                  ...
                  >
                    Checkout: {`${data.cartTotalCost.toLocaleString('vi-VN')} ₫`}
                  </div>
                )}
              </Fragment>
            ) : (
