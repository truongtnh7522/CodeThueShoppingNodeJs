    ...
    <Fragment>
      ...
      <section className="m-4 md:mx-12 md:my-6">
        <div className="grid grid-cols-2 md:grid-cols-12">
          <div className="hidden md:block md:col-span-1 md:flex-col md:space-y-4 md:mr-2">
            <img
              onClick={(e) =>
          ...
          <div className="col-span-2 mt-8 md:mt-0 md:col-span-4 ">
            <div className="flex flex-col leading-8">
              ...
              {sProduct.pOffer !== 0 && sProduct.pOffer !== "0" ? (
                  <span className="md:text-2xl font-semibold  tracking-wider text-yellow-700 text-xl">
                    {new Intl.NumberFormat('vi-VN', { style: 'currency', currency: 'VND' }).format(sProduct.pPrice)}
                    <span className="md:text-[17px] text-[15px] relative top-[1px] right-1 sm:right-[0px] line-through p-1 text-black">
                      {new Intl.NumberFormat('vi-VN', { style: 'currency', currency: 'VND' }).format(sProduct.pOffer)}
                    </span>{" "}
                  </span>
                ) : (
            ...
            <strong className="">Thông tin nổi bật</strong>
              <div className="my-4 md:my-6">{sProduct.pDescription}</div>
            </div>
